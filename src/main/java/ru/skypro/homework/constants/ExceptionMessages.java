...
public final class ExceptionMessages {
    ...
    public static final String COMMENT_NOT_FOUND = "Комментарий с id %d для объявления %d не найден";
    ...
    public static final String USER_ALREADY_EXISTS = "Пользователь с указанным email %s уже существует";
    public static final String USER_NOT_AUTHENTICATED = "Пользователь не авторизован";
    public static final String USE_ACTUAL_REGISTER_METHOD = "Для регистрации должен использоваться корректный метод с полным набором данных";
    public static final String USE_ACTUAL_UPDATE_METHOD = "Для обновления информации должен использоваться корректный метод с полным набором данных";
